...
import pipedriveWebhookRoutes from './routes/webhooks/pipedrive';
// import procoreWebhookRoutes from './routes/webhooks/procore';
...
import middeskWebhookRoutes from './routes/webhooks/middesk';
...
app.use('/api/webhooks/pipedrive', pipedriveWebhookRoutes);
// app.use('/api/webhooks/procore', procoreWebhookRoutes);
// app.use('/api/webhooks/xero', xeroWebhookRoutes);
...
app.use('/api/webhooks/middesk', middeskWebhookRoutes);
