...
registry.registerPath({
  ...
  description:
    ...
    'Maestro schema check (at most once every 5 minutes per org) so saved trigger schemas stay fresh.',
  security: SECURITY,
  responses: {
    200: {
...
registry.registerPath({
  ...
  description: 'Requires admin role. Use this for workflows not yet bound to a Maestro workflow id.',
  security: SECURITY,
  request: {
...
registry.registerPath({
  ...
  tags: [TAG],
  summary: 'Sync all workflows from DocuSign Maestro',
  description:
    'Requires admin role. Pulls all workflows from Maestro into the org, creating/updating ' +
    'local records and deleting orphans no longer present in Maestro.',
  security: SECURITY,
  request: {
...
registry.registerPath({
  ...
  tags: [TAG],
  summary: 'Sync a single workflow\'s trigger schema from Maestro',
  security: SECURITY,
  request: { params: idParam },
  responses: {
    200: {
...
registry.registerPath({
  ...
  description: 'Requires member role. Creates a new Maestro instance and a matching local instance record.',
  security: SECURITY,
  request: {
    params: idParam,
...
registry.registerPath({
  ...
  description:
    'Returns up to 50 most recent instances. When `live=true`, statuses are enriched from Maestro and ' +
  ...
  request: {
    ...
    query: z.object({
      live: z.enum(['true', 'false']).optional().openapi({
        description: 'When `true`, enriches instances with live Maestro state.',
      }),
    }),
  },
  responses: {
...
registry.registerPath({
  ...
  description: 'Requires admin role. Only the local record is removed; Maestro state is untouched.',
  security: SECURITY,
  request: { params: idParam },
  responses: {
    200: {
