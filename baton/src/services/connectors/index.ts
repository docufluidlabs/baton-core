...
// import { procoreConnector } from './procore.connector';
...
connectorRegistry.set('pipedrive', pipedriveConnector);
// connectorRegistry.set('procore', procoreConnector);
connectorRegistry.set('docusign', docusignConnector);
// connectorRegistry.set('xero', xeroConnector);
