...
export default function Salesforce() {
  return (
    <>
      ...
      <Callout type="note" title="Hosted-cloud users">The hosted Baton service additionally offers a managed Salesforce package that automates these steps. It is pre-authorized against the hosted cloud only, so self-hosted installations use the manual setup on this page.</Callout>
