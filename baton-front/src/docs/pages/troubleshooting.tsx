...
export default function Troubleshooting() {
  return (
    <>
      ...
      <p>
        Baton accepted the webhook, but the Maestro workflow did not run as you expected. The Action status
        tells you why.
      </p>
      <TableWrap>
        <table>
          ...
          <tbody>
            ...
            <tr><td><code>upstream_error</code></td><td>Maestro returned an error when Baton tried to launch the workflow.</td><td>Baton retries automatically. If all retries fail, Retry the run from <DocLink to="control-center">Resolution Center</DocLink>.</td></tr>
          </tbody>
        </table>
      </TableWrap>
      ...
      <p>
        When Maestro returns an error on launch, Baton does not give up immediately. It automatically
      ...
      <p>
        If a workflow does not appear in the Target Maestro Workflow dropdown, it may be a{' '}
        <strong>draft</strong> in Maestro — drafts do not sync — or you need to click{' '}
      ...
      <KV>
        ...
        <KVRow label="A failed instance won't cancel">
          Some Maestro states — for example a run that has already completed or been cancelled — cannot be
          cancelled. Baton shows Maestro's own message explaining why.
        </KVRow>
      </KV>
      ...
      <Callout type="note" title="Still stuck?">
        ...
        they let support trace exactly what happened.
      </Callout>
      ...
      <Cards>
        ...
        <Card to="control-center" title="Resolution Center">Retry, cancel, or report failed Maestro instances.</Card>
      </Cards>
    </>
  );
}
