    ...
    <div className="baton-docs">
      ...
      <header className="bd-topbar">
        ...
        <Link className="bd-brand" to="/docs">
          {/* The on-dark brand variant: the "b" body is white, not the #05162B of
              the on-light mark, which would sit invisibly on the --ink topbar.
              Matches baton-logo-mark-white.svg in the brand kit. */}
