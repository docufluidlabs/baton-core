...
const dashboard = {
  ...
  recentEvents: [
    ...
    { id: 'ev-4', orgId: 'org-1', eventType: 'deal.updated', status: 'failed', eventSummary: 'Pipedrive deal sync failed', sourcePlatform: 'pipedrive', triggeredAt: hoursAgo(3), errorMessage: '401 Unauthorized' },
  ...
  connections: [
    ...
    { id: 'conn-4', platform: 'pipedrive', displayName: 'Pipedrive', status: 'healthy', hasAccessToken: true, hasRefreshToken: false, createdAt: daysAgo(15) },
  ],
};
...
const platforms = {
  platforms: [
    ...
    { platform: 'pipedrive', displayName: 'Pipedrive', eventTypes: [
      { eventType: 'deal.created', label: 'Deal Created', description: 'A new deal was created' },
...
const rules = {
  rules: [
    ...
    { id: 'r-4', name: 'Sync Zoho deals', orgId: 'org-1', appSlug: 'zohocrm', sourcePlatform: 'zohocrm', eventType: 'deals.created', eventLabel: 'Deal Created', targetWorkflowId: 'wf-4', actionConfig: {}, status: 'error' as const, timesTriggered: 8, failureCount: 5, successRate: 37.5, lastTriggeredAt: hoursAgo(3), createdAt: daysAgo(15), webhookUrl: 'https://api.iambaton.com/api/webhooks/rule/d4e5f6g7h8i9' },
    { id: 'r-5', name: 'Notify on lost deals', orgId: 'org-1', appSlug: 'salesforce', sourcePlatform: 'salesforce', eventType: 'opportunity.closed', eventLabel: 'Opportunity Closed', targetWorkflowId: 'wf-5', actionConfig: {}, status: 'active' as const, timesTriggered: 2, failureCount: 0, successRate: 100, lastTriggeredAt: daysAgo(3), createdAt: daysAgo(10), webhookUrl: 'https://api.iambaton.com/api/webhooks/rule/e5f6g7h8i9j0' },
    { id: 'r-6', name: 'Pipedrive deal → CRM sync', orgId: 'org-1', appSlug: 'pipedrive', sourcePlatform: 'pipedrive', eventType: 'deal.created', eventLabel: 'Deal Created', targetWorkflowId: 'wf-4', actionConfig: {}, status: 'active' as const, timesTriggered: 12, failureCount: 0, successRate: 100, lastTriggeredAt: hoursAgo(12), createdAt: daysAgo(8), webhookUrl: 'https://api.iambaton.com/api/webhooks/rule/f6g7h8i9j0k1' },
    { id: 'r-7', name: 'Zoho lead → routing', orgId: 'org-1', appSlug: 'zohocrm', sourcePlatform: 'zohocrm', eventType: 'leads.created', eventLabel: 'Lead Created', targetWorkflowId: 'wf-1', actionConfig: {}, status: 'paused' as const, timesTriggered: 0, failureCount: 0, createdAt: daysAgo(3), webhookUrl: 'https://api.iambaton.com/api/webhooks/rule/g7h8i9j0k1l2' },
    { id: 'r-8', name: 'New org → onboarding', orgId: 'org-1', appSlug: 'pipedrive', sourcePlatform: 'pipedrive', eventType: 'organization.created', eventLabel: 'Organization Created', targetWorkflowId: 'wf-6', actionConfig: {}, status: 'active' as const, timesTriggered: 5, failureCount: 0, successRate: 100, lastTriggeredAt: daysAgo(1), createdAt: daysAgo(5), webhookUrl: 'https://api.iambaton.com/api/webhooks/rule/h8i9j0k1l2m3' },
  ],
};
...
const appsCatalog = {
  catalog: [
    ...
    { slug: 'pipedrive', displayName: 'Pipedrive', icon: '🟢', category: 'CRM', description: 'Sales CRM — deals, persons, organizations', webhookCapable: true },
  ],
};
...
const platformTemplates = {
  templates: [
    ...
    {
      slug: 'pipedrive', name: 'Pipedrive', icon: '🟢', category: 'CRM',
      description: 'Sales CRM — deals, persons, organizations', webhookCapable: true as const,
      secretKeyLabel: 'Webhook Auth Token', secretKeyHint: 'Found in Pipedrive → Settings → Webhooks',
      setupInstructions: [
        { step: 1, title: 'Open Pipedrive Settings', description: 'Go to Settings → Webhooks' },
        { step: 2, title: 'Add Webhook', description: 'Create a new webhook subscription with your URL' },
        { step: 3, title: 'Copy Auth Token', description: 'Copy the authentication token' },
      ],
      supportedEvents: [
        { eventType: 'deal.created', label: 'Deal Created', description: 'A new deal was created' },
        { eventType: 'person.created', label: 'Person Created', description: 'A new person was created' },
  ...
  window.fetch = async (input: RequestInfo | URL, init?: RequestInit) => {
    ...
    if (url.startsWith('/api')) {
      ...
      if (queueMatch && (!init?.method || init.method === 'GET')) {
        await delay(200);
        const items = [
          { id: 'q-1', ruleId: queueMatch[1], platform: 'pipedrive', eventType: 'deal.updated', eventSummary: 'Deal "Acme Corp" updated', queuedAt: new Date(Date.now() - 120_000).toISOString(), status: 'queued' },
          { id: 'q-2', ruleId: queueMatch[1], platform: 'pipedrive', eventType: 'deal.won', eventSummary: 'Deal "Widget Co" marked won', queuedAt: new Date(Date.now() - 45_000).toISOString(), status: 'queued' },
        ];
